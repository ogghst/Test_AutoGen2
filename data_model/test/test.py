...
linkml_meta = LinkMLMeta({'default_prefix': 'http://example.org/my_schema/',
     ...
     'name': 'my_schema',
     'source_file': 'data_model/test/test.yaml'} )
...
class Project(ConfiguredBaseModel):
    ...
    id: str = Field(default=..., description="""Unique UUIDv4 identifier""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Project', 'User', 'Issue', 'Edge']} })
    name: Optional[str] = Field(default=None, description="""Name""", json_schema_extra = { "linkml_meta": {'alias': 'name', 'domain_of': ['Project', 'User']} })
...
class User(ConfiguredBaseModel):
    ...
    id: str = Field(default=..., description="""Unique UUIDv4 identifier""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Project', 'User', 'Issue', 'Edge']} })
    name: Optional[str] = Field(default=None, description="""Name""", json_schema_extra = { "linkml_meta": {'alias': 'name', 'domain_of': ['Project', 'User']} })
    email: Optional[str] = Field(default=None, description="""Email address""", json_schema_extra = { "linkml_meta": {'alias': 'email', 'domain_of': ['User']} })
...
class Issue(ConfiguredBaseModel):
    ...
    id: str = Field(default=..., description="""Unique UUIDv4 identifier""", json_schema_extra = { "linkml_meta": {'alias': 'id', 'domain_of': ['Project', 'User', 'Issue', 'Edge']} })
    title: Optional[str] = Field(default=None, description="""Title""", json_schema_extra = { "linkml_meta": {'alias': 'title', 'domain_of': ['Issue']} })
    description: Optional[str] = Field(default=None, description="""Description""", json_schema_extra = { "linkml_meta": {'alias': 'description', 'domain_of': ['Issue']} })
