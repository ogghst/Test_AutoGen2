...
def configure_oltp_tracing(endpoint: str = "http://localhost:4317") -> trace.TracerProvider:
    """
    Configure OpenTelemetry tracing with the specified endpoint.
    
    Args:
        endpoint: OTLP endpoint for trace export (default: http://localhost:4317)
