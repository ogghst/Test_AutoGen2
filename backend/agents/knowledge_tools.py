...
def get_tools(user_session: "UserSession") -> List[FunctionTool]:  # Use string literal for forward reference
    
    knowledge_service = user_session.knowledge_service
    
    async def get_actual_project_context() -> str:
        """
        Get the actual project data in JSON format
        
        Returns:
            str: A JSON-formatted string representing the project data.
                If the project is not found, returns a JSON string with an "error" key and message.
        ...
        Example:
            {
                ...
                "name": "Project Alpha",
        """
        return get_full_project_context(user_session.project_id)
    ...
    get_actual_project_context_tool = FunctionTool(
        get_actual_project_context,
        description="Get the actual project data in JSON format. Returns JSON string."
    )
    ...
    return [
        get_actual_project_context_tool,
