...
def create_knowledge_tools(user_session: UserSession) -> List[FunctionTool]:
    ...
    async def create_edge(edge: Annotated[Edge, "The Edge object to create, representing a relationship between two entities."]) -> str:
        """
    ...
    create_edge_tool = FunctionTool(
        create_edge,
        description="Create a new Edge entity that represents a relationship between two entities."
    )
